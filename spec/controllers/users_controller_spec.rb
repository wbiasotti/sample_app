...
describe UsersController do
  ...
  describe "GET 'index'"do
	...
	response.should have_selector('span', :class => "previous_page disabled", :content => "Previous")
  ...
  describe "GET 'show'" do
    ...
    it "should show the user's microposts" do
      ...
      mp2 = Factory(:micropost, :user => @user, :content => "barfoo")
      get :show, :id => @user
  ...
  describe "Put 'update'" do
	...
	@user.encryption_password == user.encryption_password
      end
